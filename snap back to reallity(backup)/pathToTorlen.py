...
'''))
                    ...
                    button_d = Button(text = str(shop_zone.description),size_hint=(.9,.7))
            ...
            if game.shield.collide_widget(self):
                if not(shop_zone.not_touched):
                    if shop_zone.not_kuplen:
                        self.buy(shop_zone.item,shop_zone.cost,game)
